...
API REST com Spring Boot que consulta locais de filmagem em San Francisco a partir do SF Open Data, permitindo listar filmes, filtrar por titulo e obter sugestoes de autocomplete.
